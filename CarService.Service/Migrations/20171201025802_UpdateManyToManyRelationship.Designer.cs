...
namespace CarService.Service.Migrations
{
    ...
    [Migration("20171201025802_UpdateManyToManyRelationship")]
            ...
            modelBuilder.Entity("CarService.Service.Reservation", b =>
                {
                    ...
                    b.Property<string>("ReservationMechanicId");

                    b.Property<string>("ReservationPartnerId");
                    ...
                    b.HasIndex("ReservationMechanicId");

                    b.HasIndex("ReservationPartnerId");
            ...
            modelBuilder.Entity("CarService.Service.Worksheet", b =>
                {
                    ...
                    b.Property<string>("WorksheetMechanicId");

                    b.Property<string>("WorksheetPartnerId");

                    b.Property<int>("WorksheetReservationId");

                    b.HasKey("Id");

                    b.HasIndex("WorksheetMechanicId");

                    b.HasIndex("WorksheetPartnerId");

                    b.HasIndex("WorksheetReservationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CarService.Service.WorksheetMaterial", b =>
                {
                    ...
                    b.HasKey("WorksheetMaterialId", "MaterialWorksheetId");
            ...
            modelBuilder.Entity("CarService.Service.Worksheet", b =>
                {
                    b.HasOne("CarService.Service.User", "WorksheetMechanic")
                        ...
                        .HasForeignKey("WorksheetMechanicId");

                    b.HasOne("CarService.Service.User", "WorksheetPartner")
                        .WithMany("PartnerWorksheets")
                        .HasForeignKey("WorksheetPartnerId");

                    b.HasOne("CarService.Service.Reservation", "WorksheetReservation")
                        .WithOne("ReservationWorksheet")
                        .HasForeignKey("CarService.Service.Worksheet", "WorksheetReservationId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
